class Validator {
    ...
    isID = (value) => {
        this.validated = this.validated && this.isString(value) && value.length === 24
        return this
    }
    isString = (value) => {
    ...
    datesAreInOrder = (startDate, endDate) => {
        this.validated = this.validated && this.isDate(startDate) && this.isDate(endDate) && startDate <= endDate
        return this
    }
}
