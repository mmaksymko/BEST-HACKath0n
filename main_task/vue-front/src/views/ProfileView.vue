...
async function getAllUsersPropositions(id: string) {
  const response = await fetch(`https://trandafyl-server.onrender.com/proposition/all/${id}`, {
    method: 'GET'
  })
...
async function getAllUsersTakenPropositions(id: string) {
  const response = await fetch(`https://trandafyl-server.onrender.com/proposition/all-taken/${id}`, {
    method: 'GET'
  })
  if (!response.ok) return response.statusText
  return response.json()
      ...
      <div class="history__block">
        ...
        <div class="requests__container">
          <Volunteer :getAuthorByPropositionId="getNameOfAuthorByPropositionId" :completeProposition="completeProposition"
            v-for="item in volunteersArr" :item="item"></Volunteer>
        </div>
      </div>
      <div class="history__block">
        <div class="requests__header">
